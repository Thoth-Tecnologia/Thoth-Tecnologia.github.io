...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    maxOptionsText: function (numAll, numGroup) {
      return [
        (numAll == 1) ? 'Limite alcançado ({n} item máximo)' : 'Limite alcançado ({n} itens máximo)',
        (numGroup == 1) ? 'Limite de grupo atingido ({n} item máximo)' : 'Limite de grupo atingido ({n} itens máximo)'
      ];
    },
